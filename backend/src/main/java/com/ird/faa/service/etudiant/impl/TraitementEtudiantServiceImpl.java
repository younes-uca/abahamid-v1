...
import com.ird.faa.service.etudiant.facade.RecueilDeDonnesEtudiantService;
import com.ird.faa.service.etudiant.facade.SoinEtudiantService;
...
@Service
public class TraitementEtudiantServiceImpl extends AbstractServiceImpl<Traitement> implements TraitementEtudiantService {

@Autowired
private TraitementDao traitementDao;

        @Autowired
        private RecueilDeDonnesEtudiantService recueilDeDonnesService ;
        @Autowired
        private SoinEtudiantService soinService ;
