...
import com.ird.faa.service.medecin.facade.ExamenMedecinService;
...
@Service
public class BiologieMedecinServiceImpl extends AbstractServiceImpl<Biologie> implements BiologieMedecinService {

@Autowired
private BiologieDao biologieDao;

        @Autowired
        private ExamenMedecinService examenService ;
        @Autowired
