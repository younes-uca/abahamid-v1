...
import com.ird.faa.service.admin.facade.ExamenAdminService;
...
@Service
public class BiologieAdminServiceImpl extends AbstractServiceImpl<Biologie> implements BiologieAdminService {

@Autowired
private BiologieDao biologieDao;

        @Autowired
        private ExamenAdminService examenService ;
        @Autowired
