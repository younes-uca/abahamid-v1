...
import com.ird.faa.service.chercheur.facade.RelationChercheurService;
...
@Service
public class PatientContactChercheurServiceImpl extends AbstractServiceImpl<PatientContact> implements PatientContactChercheurService {

@Autowired
private PatientContactDao patientContactDao;

        @Autowired
        private RelationChercheurService relationService ;
