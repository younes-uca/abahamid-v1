...
import com.ird.faa.service.etudiant.facade.TagEtudiantService;
...
@Service
public class DossierMedicaleTagEtudiantServiceImpl extends AbstractServiceImpl<DossierMedicaleTag> implements DossierMedicaleTagEtudiantService {

@Autowired
private DossierMedicaleTagDao dossierMedicaleTagDao;

        @Autowired
        private TagEtudiantService tagService ;
        @Autowired
