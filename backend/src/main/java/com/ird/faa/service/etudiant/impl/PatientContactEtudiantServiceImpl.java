...
@Service
public class PatientContactEtudiantServiceImpl extends AbstractServiceImpl<PatientContact> implements PatientContactEtudiantService {

@Autowired
private PatientContactDao patientContactDao;

        @Autowired
        private RelationEtudiantService relationService ;
