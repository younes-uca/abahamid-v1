...
import com.ird.faa.service.etudiant.facade.PatientContactEtudiantService;
import com.ird.faa.service.etudiant.facade.EvoSuivEtudiantService;
import com.ird.faa.service.etudiant.facade.CompteRenduEtudiantService;
import com.ird.faa.service.etudiant.facade.TraitementEtudiantService;
import com.ird.faa.service.etudiant.facade.DossierMedicaleTagEtudiantService;
import com.ird.faa.service.etudiant.facade.PatientEtudiantService;
import com.ird.faa.service.etudiant.facade.DiagnosticEtudiantService;
import com.ird.faa.service.etudiant.facade.CliniqueEtudiantService;
import com.ird.faa.service.etudiant.facade.BiologieEtudiantService;
...
@Service
public class DossierMedicaleEtudiantServiceImpl extends AbstractServiceImpl<DossierMedicale> implements DossierMedicaleEtudiantService {

@Autowired
private DossierMedicaleDao dossierMedicaleDao;

        @Autowired
        private PatientContactEtudiantService patientContactService ;
        @Autowired
        private EvoSuivEtudiantService evoSuivService ;
        @Autowired
        private CompteRenduEtudiantService compteRenduService ;
        @Autowired
        private TraitementEtudiantService traitementService ;
        @Autowired
        private DossierMedicaleTagEtudiantService dossierMedicaleTagService ;
        @Autowired
        private PatientEtudiantService patientService ;
        @Autowired
        private DiagnosticEtudiantService diagnosticService ;
        @Autowired
        private CliniqueEtudiantService cliniqueService ;
        @Autowired
        private BiologieEtudiantService biologieService ;
        @Autowired
        private ImagerieEtudiantService imagerieService ;
