...
@Service
public class SoinChercheurServiceImpl extends AbstractServiceImpl<Soin> implements SoinChercheurService {
...
private SoinDao soinDao;
        ...
        @Autowired
        private InfirmierChercheurService infirmierService ;
