...
import com.ird.faa.service.admin.facade.PhaseImageAdminService;
...
@Service
public class ImagerieAdminServiceImpl extends AbstractServiceImpl<Imagerie> implements ImagerieAdminService {
...
private ImagerieDao imagerieDao;
        ...
        @Autowired
        private PhaseImageAdminService phaseImageService ;
