...
import com.ird.faa.service.chercheur.facade.RecueilDeDonnesChercheurService;
import com.ird.faa.service.chercheur.facade.SoinChercheurService;
...
@Service
public class TraitementChercheurServiceImpl extends AbstractServiceImpl<Traitement> implements TraitementChercheurService {

@Autowired
private TraitementDao traitementDao;

        @Autowired
        private RecueilDeDonnesChercheurService recueilDeDonnesService ;
        @Autowired
        private SoinChercheurService soinService ;
