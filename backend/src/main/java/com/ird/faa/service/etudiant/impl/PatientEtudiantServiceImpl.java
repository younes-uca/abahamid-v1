...
import com.ird.faa.service.etudiant.facade.SexeEtudiantService;
...
@Service
public class PatientEtudiantServiceImpl extends AbstractServiceImpl<Patient> implements PatientEtudiantService {

@Autowired
private PatientDao patientDao;

        @Autowired
        private SexeEtudiantService sexeService ;
        @Autowired
