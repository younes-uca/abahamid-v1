...
import com.ird.faa.service.medecin.facade.TypeImageMedecinService;
import com.ird.faa.service.medecin.facade.PhaseImageMedecinService;
...
@Service
public class ImagerieMedecinServiceImpl extends AbstractServiceImpl<Imagerie> implements ImagerieMedecinService {
...
private ImagerieDao imagerieDao;
        ...
        @Autowired
        private TypeImageMedecinService typeImageService ;
        @Autowired
        private PhaseImageMedecinService phaseImageService ;
