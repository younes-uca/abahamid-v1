...
import com.ird.faa.service.medecin.facade.PatientContactMedecinService;
import com.ird.faa.service.medecin.facade.EvoSuivMedecinService;
import com.ird.faa.service.medecin.facade.CompteRenduMedecinService;
...
import com.ird.faa.service.medecin.facade.PatientMedecinService;
import com.ird.faa.service.medecin.facade.DiagnosticMedecinService;
import com.ird.faa.service.medecin.facade.CliniqueMedecinService;
import com.ird.faa.service.medecin.facade.BiologieMedecinService;
...
@Service
public class DossierMedicaleMedecinServiceImpl extends AbstractServiceImpl<DossierMedicale> implements DossierMedicaleMedecinService {
...
private DossierMedicaleDao dossierMedicaleDao;
        ...
        @Autowired
        private EvoSuivMedecinService evoSuivService ;
        @Autowired
        private CompteRenduMedecinService compteRenduService ;
        @Autowired
        private TraitementMedecinService traitementService ;
        @Autowired
        private DossierMedicaleTagMedecinService dossierMedicaleTagService ;
        @Autowired
        private PatientMedecinService patientService ;
        @Autowired
        private DiagnosticMedecinService diagnosticService ;
        @Autowired
        private CliniqueMedecinService cliniqueService ;
        @Autowired
        private BiologieMedecinService biologieService ;
        @Autowired
