...
import com.ird.faa.service.chercheur.facade.TypeImageChercheurService;
...
@Service
public class ImagerieChercheurServiceImpl extends AbstractServiceImpl<Imagerie> implements ImagerieChercheurService {
...
private ImagerieDao imagerieDao;
        ...
        @Autowired
        private TypeImageChercheurService typeImageService ;
        @Autowired
