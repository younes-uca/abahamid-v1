...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/actuator/info").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/medecin/login").permitAll();
            http.authorizeRequests().antMatchers("/api/etudiant/login").permitAll();
            ...
            http.authorizeRequests().antMatchers("/api/medecin/").hasAnyAuthority(AuthoritiesConstants.MEDECIN);
            http.authorizeRequests().antMatchers("/api/etudiant/").hasAnyAuthority(AuthoritiesConstants.ETUDIANT);
