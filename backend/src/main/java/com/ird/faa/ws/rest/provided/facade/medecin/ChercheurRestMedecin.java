...
import com.ird.faa.service.medecin.facade.ChercheurMedecinService;
...
@RestController
@RequestMapping("api/medecin/chercheur")
public class ChercheurRestMedecin {

@Autowired
private ChercheurMedecinService chercheurService;
