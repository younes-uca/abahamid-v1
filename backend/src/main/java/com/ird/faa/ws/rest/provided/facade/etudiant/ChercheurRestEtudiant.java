...
import com.ird.faa.service.etudiant.facade.ChercheurEtudiantService;
...
@RestController
@RequestMapping("api/etudiant/chercheur")
public class ChercheurRestEtudiant {

@Autowired
private ChercheurEtudiantService chercheurService;
