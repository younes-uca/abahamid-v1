...
import com.ird.faa.service.chercheur.facade.MedecinChercheurService;
...
@RestController
@RequestMapping("api/chercheur/medecin")
public class MedecinRestChercheur {

@Autowired
private MedecinChercheurService medecinService;
