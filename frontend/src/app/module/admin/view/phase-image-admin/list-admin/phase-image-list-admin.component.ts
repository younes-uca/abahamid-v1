...
@Component({
  selector: 'app-phase-image-list-admin',
  templateUrl: './phase-image-list-admin.component.html',
  styleUrls: ['./phase-image-list-admin.component.css']
})
export class PhaseImageListAdminComponent implements OnInit {
   // declarations
