...
@Component({
  selector: 'app-phase-image-edit-admin',
  templateUrl: './phase-image-edit-admin.component.html',
  styleUrls: ['./phase-image-edit-admin.component.css']
})
export class PhaseImageEditAdminComponent implements OnInit {
