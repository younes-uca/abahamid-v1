...
@Component({
  selector: 'app-phase-image-view-admin',
  templateUrl: './phase-image-view-admin.component.html',
  styleUrls: ['./phase-image-view-admin.component.css']
})
export class PhaseImageViewAdminComponent implements OnInit {
