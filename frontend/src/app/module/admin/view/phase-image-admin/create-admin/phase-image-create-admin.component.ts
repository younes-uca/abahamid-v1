...
@Component({
  selector: 'app-phase-image-create-admin',
  templateUrl: './phase-image-create-admin.component.html',
  styleUrls: ['./phase-image-create-admin.component.css']
})
export class PhaseImageCreateAdminComponent implements OnInit {
