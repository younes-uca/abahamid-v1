...
@Component({
  selector: 'app-biologie-list-admin',
  templateUrl: './biologie-list-admin.component.html',
  styleUrls: ['./biologie-list-admin.component.css']
})
export class BiologieListAdminComponent implements OnInit {
   // declarations
