...
@Component({
  selector: 'app-biologie-create-admin',
  templateUrl: './biologie-create-admin.component.html',
  styleUrls: ['./biologie-create-admin.component.css']
})
export class BiologieCreateAdminComponent implements OnInit {
