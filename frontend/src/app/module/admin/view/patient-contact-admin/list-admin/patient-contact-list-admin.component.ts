...
@Component({
  selector: 'app-patient-contact-list-admin',
  templateUrl: './patient-contact-list-admin.component.html',
  styleUrls: ['./patient-contact-list-admin.component.css']
})
export class PatientContactListAdminComponent implements OnInit {
   // declarations
