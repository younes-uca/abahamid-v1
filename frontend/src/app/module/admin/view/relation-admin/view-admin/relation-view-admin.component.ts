...
@Component({
  selector: 'app-relation-view-admin',
  templateUrl: './relation-view-admin.component.html',
  styleUrls: ['./relation-view-admin.component.css']
})
export class RelationViewAdminComponent implements OnInit {
