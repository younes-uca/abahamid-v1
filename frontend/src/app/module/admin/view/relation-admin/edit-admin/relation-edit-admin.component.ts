...
@Component({
  selector: 'app-relation-edit-admin',
  templateUrl: './relation-edit-admin.component.html',
  styleUrls: ['./relation-edit-admin.component.css']
})
export class RelationEditAdminComponent implements OnInit {
