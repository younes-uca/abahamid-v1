...
@Component({
  selector: 'app-relation-list-admin',
  templateUrl: './relation-list-admin.component.html',
  styleUrls: ['./relation-list-admin.component.css']
})
export class RelationListAdminComponent implements OnInit {
   // declarations
