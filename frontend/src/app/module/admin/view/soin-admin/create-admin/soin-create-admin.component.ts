...
@Component({
  selector: 'app-soin-create-admin',
  templateUrl: './soin-create-admin.component.html',
  styleUrls: ['./soin-create-admin.component.css']
})
export class SoinCreateAdminComponent implements OnInit {
