...
@Component({
  selector: 'app-soin-edit-admin',
  templateUrl: './soin-edit-admin.component.html',
  styleUrls: ['./soin-edit-admin.component.css']
})
export class SoinEditAdminComponent implements OnInit {
