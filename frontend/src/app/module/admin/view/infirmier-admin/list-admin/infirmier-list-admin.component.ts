...
@Component({
  selector: 'app-infirmier-list-admin',
  templateUrl: './infirmier-list-admin.component.html',
  styleUrls: ['./infirmier-list-admin.component.css']
})
export class InfirmierListAdminComponent implements OnInit {
   // declarations
