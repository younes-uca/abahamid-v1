...
@Component({
  selector: 'app-infirmier-view-admin',
  templateUrl: './infirmier-view-admin.component.html',
  styleUrls: ['./infirmier-view-admin.component.css']
})
export class InfirmierViewAdminComponent implements OnInit {
