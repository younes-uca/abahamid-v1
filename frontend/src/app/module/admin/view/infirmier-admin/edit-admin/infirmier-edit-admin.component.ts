...
@Component({
  selector: 'app-infirmier-edit-admin',
  templateUrl: './infirmier-edit-admin.component.html',
  styleUrls: ['./infirmier-edit-admin.component.css']
})
export class InfirmierEditAdminComponent implements OnInit {
