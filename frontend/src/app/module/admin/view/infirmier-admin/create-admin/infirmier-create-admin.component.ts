...
@Component({
  selector: 'app-infirmier-create-admin',
  templateUrl: './infirmier-create-admin.component.html',
  styleUrls: ['./infirmier-create-admin.component.css']
})
export class InfirmierCreateAdminComponent implements OnInit {
