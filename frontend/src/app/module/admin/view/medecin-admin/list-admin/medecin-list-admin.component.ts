...
@Component({
  selector: 'app-medecin-list-admin',
  templateUrl: './medecin-list-admin.component.html',
  styleUrls: ['./medecin-list-admin.component.css']
})
export class MedecinListAdminComponent implements OnInit {
   // declarations
