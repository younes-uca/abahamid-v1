...
@Component({
  selector: 'app-medecin-edit-admin',
  templateUrl: './medecin-edit-admin.component.html',
  styleUrls: ['./medecin-edit-admin.component.css']
})
export class MedecinEditAdminComponent implements OnInit {
