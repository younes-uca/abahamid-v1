...
@Component({
  selector: 'app-medecin-create-admin',
  templateUrl: './medecin-create-admin.component.html',
  styleUrls: ['./medecin-create-admin.component.css']
})
export class MedecinCreateAdminComponent implements OnInit {
