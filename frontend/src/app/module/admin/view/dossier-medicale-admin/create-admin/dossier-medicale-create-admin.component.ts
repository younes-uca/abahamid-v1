...
@Component({
  selector: 'app-dossier-medicale-create-admin',
  templateUrl: './dossier-medicale-create-admin.component.html',
  styleUrls: ['./dossier-medicale-create-admin.component.css']
})
export class DossierMedicaleCreateAdminComponent implements OnInit {
