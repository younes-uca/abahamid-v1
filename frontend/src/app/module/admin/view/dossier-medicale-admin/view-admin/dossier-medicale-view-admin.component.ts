...
@Component({
  selector: 'app-dossier-medicale-view-admin',
  templateUrl: './dossier-medicale-view-admin.component.html',
  styleUrls: ['./dossier-medicale-view-admin.component.css']
})
export class DossierMedicaleViewAdminComponent implements OnInit {
