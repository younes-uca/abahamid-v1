...
@Component({
  selector: 'app-dossier-medicale-edit-admin',
  templateUrl: './dossier-medicale-edit-admin.component.html',
  styleUrls: ['./dossier-medicale-edit-admin.component.css']
})
export class DossierMedicaleEditAdminComponent implements OnInit {
