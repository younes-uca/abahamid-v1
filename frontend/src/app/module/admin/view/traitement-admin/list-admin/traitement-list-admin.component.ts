...
@Component({
  selector: 'app-traitement-list-admin',
  templateUrl: './traitement-list-admin.component.html',
  styleUrls: ['./traitement-list-admin.component.css']
})
export class TraitementListAdminComponent implements OnInit {
   // declarations
