...
@Component({
  selector: 'app-traitement-edit-admin',
  templateUrl: './traitement-edit-admin.component.html',
  styleUrls: ['./traitement-edit-admin.component.css']
})
export class TraitementEditAdminComponent implements OnInit {
