...
@Component({
  selector: 'app-traitement-create-admin',
  templateUrl: './traitement-create-admin.component.html',
  styleUrls: ['./traitement-create-admin.component.css']
})
export class TraitementCreateAdminComponent implements OnInit {
