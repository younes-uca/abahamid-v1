...
@Component({
  selector: 'app-compte-rendu-list-admin',
  templateUrl: './compte-rendu-list-admin.component.html',
  styleUrls: ['./compte-rendu-list-admin.component.css']
})
export class CompteRenduListAdminComponent implements OnInit {
   // declarations
