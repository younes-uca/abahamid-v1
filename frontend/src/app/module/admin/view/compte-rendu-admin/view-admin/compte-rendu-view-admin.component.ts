...
@Component({
  selector: 'app-compte-rendu-view-admin',
  templateUrl: './compte-rendu-view-admin.component.html',
  styleUrls: ['./compte-rendu-view-admin.component.css']
})
export class CompteRenduViewAdminComponent implements OnInit {
