...
@Component({
  selector: 'app-compte-rendu-edit-admin',
  templateUrl: './compte-rendu-edit-admin.component.html',
  styleUrls: ['./compte-rendu-edit-admin.component.css']
})
export class CompteRenduEditAdminComponent implements OnInit {
