...
@Component({
  selector: 'app-type-image-list-admin',
  templateUrl: './type-image-list-admin.component.html',
  styleUrls: ['./type-image-list-admin.component.css']
})
export class TypeImageListAdminComponent implements OnInit {
   // declarations
