...
@Component({
  selector: 'app-type-image-create-admin',
  templateUrl: './type-image-create-admin.component.html',
  styleUrls: ['./type-image-create-admin.component.css']
})
export class TypeImageCreateAdminComponent implements OnInit {
