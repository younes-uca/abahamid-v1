...
@Component({
  selector: 'app-diagnostic-edit-admin',
  templateUrl: './diagnostic-edit-admin.component.html',
  styleUrls: ['./diagnostic-edit-admin.component.css']
})
export class DiagnosticEditAdminComponent implements OnInit {
