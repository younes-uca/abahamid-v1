...
@Component({
  selector: 'app-diagnostic-list-admin',
  templateUrl: './diagnostic-list-admin.component.html',
  styleUrls: ['./diagnostic-list-admin.component.css']
})
export class DiagnosticListAdminComponent implements OnInit {
   // declarations
