...
@Component({
  selector: 'app-diagnostic-create-admin',
  templateUrl: './diagnostic-create-admin.component.html',
  styleUrls: ['./diagnostic-create-admin.component.css']
})
export class DiagnosticCreateAdminComponent implements OnInit {
