...
@Component({
  selector: 'app-diagnostic-view-admin',
  templateUrl: './diagnostic-view-admin.component.html',
  styleUrls: ['./diagnostic-view-admin.component.css']
})
export class DiagnosticViewAdminComponent implements OnInit {
