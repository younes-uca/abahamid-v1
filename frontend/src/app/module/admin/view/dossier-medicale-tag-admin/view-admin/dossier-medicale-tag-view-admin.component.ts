...
@Component({
  selector: 'app-dossier-medicale-tag-view-admin',
  templateUrl: './dossier-medicale-tag-view-admin.component.html',
  styleUrls: ['./dossier-medicale-tag-view-admin.component.css']
})
export class DossierMedicaleTagViewAdminComponent implements OnInit {
