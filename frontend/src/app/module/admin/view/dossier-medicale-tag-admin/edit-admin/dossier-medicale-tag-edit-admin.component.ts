...
@Component({
  selector: 'app-dossier-medicale-tag-edit-admin',
  templateUrl: './dossier-medicale-tag-edit-admin.component.html',
  styleUrls: ['./dossier-medicale-tag-edit-admin.component.css']
})
export class DossierMedicaleTagEditAdminComponent implements OnInit {
