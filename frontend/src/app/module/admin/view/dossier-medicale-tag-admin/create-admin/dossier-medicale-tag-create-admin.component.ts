...
@Component({
  selector: 'app-dossier-medicale-tag-create-admin',
  templateUrl: './dossier-medicale-tag-create-admin.component.html',
  styleUrls: ['./dossier-medicale-tag-create-admin.component.css']
})
export class DossierMedicaleTagCreateAdminComponent implements OnInit {
