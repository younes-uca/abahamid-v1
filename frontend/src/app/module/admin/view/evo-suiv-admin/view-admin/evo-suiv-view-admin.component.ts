...
@Component({
  selector: 'app-evo-suiv-view-admin',
  templateUrl: './evo-suiv-view-admin.component.html',
  styleUrls: ['./evo-suiv-view-admin.component.css']
})
export class EvoSuivViewAdminComponent implements OnInit {
