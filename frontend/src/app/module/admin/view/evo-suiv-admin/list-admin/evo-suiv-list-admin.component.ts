...
@Component({
  selector: 'app-evo-suiv-list-admin',
  templateUrl: './evo-suiv-list-admin.component.html',
  styleUrls: ['./evo-suiv-list-admin.component.css']
})
export class EvoSuivListAdminComponent implements OnInit {
   // declarations
