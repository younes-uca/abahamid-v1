...
@Component({
  selector: 'app-imagerie-view-admin',
  templateUrl: './imagerie-view-admin.component.html',
  styleUrls: ['./imagerie-view-admin.component.css']
})
export class ImagerieViewAdminComponent implements OnInit {
