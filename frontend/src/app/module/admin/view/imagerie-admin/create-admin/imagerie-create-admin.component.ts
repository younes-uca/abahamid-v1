...
@Component({
  selector: 'app-imagerie-create-admin',
  templateUrl: './imagerie-create-admin.component.html',
  styleUrls: ['./imagerie-create-admin.component.css']
})
export class ImagerieCreateAdminComponent implements OnInit {
