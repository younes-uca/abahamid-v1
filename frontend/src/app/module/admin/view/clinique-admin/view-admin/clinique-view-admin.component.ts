...
@Component({
  selector: 'app-clinique-view-admin',
  templateUrl: './clinique-view-admin.component.html',
  styleUrls: ['./clinique-view-admin.component.css']
})
export class CliniqueViewAdminComponent implements OnInit {
