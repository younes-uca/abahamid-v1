...
@Component({
  selector: 'app-clinique-list-admin',
  templateUrl: './clinique-list-admin.component.html',
  styleUrls: ['./clinique-list-admin.component.css']
})
export class CliniqueListAdminComponent implements OnInit {
   // declarations
