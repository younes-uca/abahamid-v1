...
@Component({
  selector: 'app-clinique-create-admin',
  templateUrl: './clinique-create-admin.component.html',
  styleUrls: ['./clinique-create-admin.component.css']
})
export class CliniqueCreateAdminComponent implements OnInit {
