...
@Component({
  selector: 'app-clinique-edit-admin',
  templateUrl: './clinique-edit-admin.component.html',
  styleUrls: ['./clinique-edit-admin.component.css']
})
export class CliniqueEditAdminComponent implements OnInit {
