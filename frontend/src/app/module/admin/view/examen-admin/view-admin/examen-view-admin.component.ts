...
@Component({
  selector: 'app-examen-view-admin',
  templateUrl: './examen-view-admin.component.html',
  styleUrls: ['./examen-view-admin.component.css']
})
export class ExamenViewAdminComponent implements OnInit {
