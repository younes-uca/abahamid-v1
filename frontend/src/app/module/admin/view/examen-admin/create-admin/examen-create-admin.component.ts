...
@Component({
  selector: 'app-examen-create-admin',
  templateUrl: './examen-create-admin.component.html',
  styleUrls: ['./examen-create-admin.component.css']
})
export class ExamenCreateAdminComponent implements OnInit {
