...
@Component({
  selector: 'app-examen-edit-admin',
  templateUrl: './examen-edit-admin.component.html',
  styleUrls: ['./examen-edit-admin.component.css']
})
export class ExamenEditAdminComponent implements OnInit {
