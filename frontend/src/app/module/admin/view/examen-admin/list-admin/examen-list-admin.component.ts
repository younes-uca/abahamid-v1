...
@Component({
  selector: 'app-examen-list-admin',
  templateUrl: './examen-list-admin.component.html',
  styleUrls: ['./examen-list-admin.component.css']
})
export class ExamenListAdminComponent implements OnInit {
   // declarations
