...
@Component({
  selector: 'app-recueil-de-donnes-list-admin',
  templateUrl: './recueil-de-donnes-list-admin.component.html',
  styleUrls: ['./recueil-de-donnes-list-admin.component.css']
})
export class RecueilDeDonnesListAdminComponent implements OnInit {
   // declarations
