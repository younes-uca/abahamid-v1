...
@Component({
  selector: 'app-recueil-de-donnes-view-admin',
  templateUrl: './recueil-de-donnes-view-admin.component.html',
  styleUrls: ['./recueil-de-donnes-view-admin.component.css']
})
export class RecueilDeDonnesViewAdminComponent implements OnInit {
