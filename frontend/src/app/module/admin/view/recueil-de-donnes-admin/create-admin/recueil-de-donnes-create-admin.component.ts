...
@Component({
  selector: 'app-recueil-de-donnes-create-admin',
  templateUrl: './recueil-de-donnes-create-admin.component.html',
  styleUrls: ['./recueil-de-donnes-create-admin.component.css']
})
export class RecueilDeDonnesCreateAdminComponent implements OnInit {
