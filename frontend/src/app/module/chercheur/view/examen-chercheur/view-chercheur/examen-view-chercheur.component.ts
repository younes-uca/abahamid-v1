...
@Component({
  selector: 'app-examen-view-chercheur',
  templateUrl: './examen-view-chercheur.component.html',
  styleUrls: ['./examen-view-chercheur.component.css']
})
export class ExamenViewChercheurComponent implements OnInit {
