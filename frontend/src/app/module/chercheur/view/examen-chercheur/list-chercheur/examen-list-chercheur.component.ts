...
@Component({
  selector: 'app-examen-list-chercheur',
  templateUrl: './examen-list-chercheur.component.html',
  styleUrls: ['./examen-list-chercheur.component.css']
})
export class ExamenListChercheurComponent implements OnInit {
   // declarations
