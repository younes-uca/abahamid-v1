...
@Component({
  selector: 'app-ville-list-chercheur',
  templateUrl: './ville-list-chercheur.component.html',
  styleUrls: ['./ville-list-chercheur.component.css']
})
export class VilleListChercheurComponent implements OnInit {
   // declarations
