...
@Component({
  selector: 'app-medecin-view-chercheur',
  templateUrl: './medecin-view-chercheur.component.html',
  styleUrls: ['./medecin-view-chercheur.component.css']
})
export class MedecinViewChercheurComponent implements OnInit {
