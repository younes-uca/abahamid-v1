...
@Component({
  selector: 'app-medecin-edit-chercheur',
  templateUrl: './medecin-edit-chercheur.component.html',
  styleUrls: ['./medecin-edit-chercheur.component.css']
})
export class MedecinEditChercheurComponent implements OnInit {
