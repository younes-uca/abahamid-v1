...
@Component({
  selector: 'app-medecin-list-chercheur',
  templateUrl: './medecin-list-chercheur.component.html',
  styleUrls: ['./medecin-list-chercheur.component.css']
})
export class MedecinListChercheurComponent implements OnInit {
   // declarations
