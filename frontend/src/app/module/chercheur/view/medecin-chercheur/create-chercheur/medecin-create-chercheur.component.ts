...
@Component({
  selector: 'app-medecin-create-chercheur',
  templateUrl: './medecin-create-chercheur.component.html',
  styleUrls: ['./medecin-create-chercheur.component.css']
})
export class MedecinCreateChercheurComponent implements OnInit {
