...
@Component({
  selector: 'app-tag-edit-chercheur',
  templateUrl: './tag-edit-chercheur.component.html',
  styleUrls: ['./tag-edit-chercheur.component.css']
})
export class TagEditChercheurComponent implements OnInit {
