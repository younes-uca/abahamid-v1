...
@Component({
  selector: 'app-compte-rendu-list-chercheur',
  templateUrl: './compte-rendu-list-chercheur.component.html',
  styleUrls: ['./compte-rendu-list-chercheur.component.css']
})
export class CompteRenduListChercheurComponent implements OnInit {
   // declarations
