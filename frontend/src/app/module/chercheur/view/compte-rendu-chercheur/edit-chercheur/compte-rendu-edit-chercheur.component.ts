...
@Component({
  selector: 'app-compte-rendu-edit-chercheur',
  templateUrl: './compte-rendu-edit-chercheur.component.html',
  styleUrls: ['./compte-rendu-edit-chercheur.component.css']
})
export class CompteRenduEditChercheurComponent implements OnInit {
