...
@Component({
  selector: 'app-compte-rendu-view-chercheur',
  templateUrl: './compte-rendu-view-chercheur.component.html',
  styleUrls: ['./compte-rendu-view-chercheur.component.css']
})
export class CompteRenduViewChercheurComponent implements OnInit {
