...
@Component({
  selector: 'app-compte-rendu-create-chercheur',
  templateUrl: './compte-rendu-create-chercheur.component.html',
  styleUrls: ['./compte-rendu-create-chercheur.component.css']
})
export class CompteRenduCreateChercheurComponent implements OnInit {
