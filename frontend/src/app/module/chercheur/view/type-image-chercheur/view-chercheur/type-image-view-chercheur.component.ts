...
@Component({
  selector: 'app-type-image-view-chercheur',
  templateUrl: './type-image-view-chercheur.component.html',
  styleUrls: ['./type-image-view-chercheur.component.css']
})
export class TypeImageViewChercheurComponent implements OnInit {
