...
@Component({
  selector: 'app-type-image-list-chercheur',
  templateUrl: './type-image-list-chercheur.component.html',
  styleUrls: ['./type-image-list-chercheur.component.css']
})
export class TypeImageListChercheurComponent implements OnInit {
   // declarations
