...
@Component({
  selector: 'app-biologie-view-chercheur',
  templateUrl: './biologie-view-chercheur.component.html',
  styleUrls: ['./biologie-view-chercheur.component.css']
})
export class BiologieViewChercheurComponent implements OnInit {
