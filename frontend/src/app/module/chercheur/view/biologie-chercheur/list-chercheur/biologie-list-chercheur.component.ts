...
@Component({
  selector: 'app-biologie-list-chercheur',
  templateUrl: './biologie-list-chercheur.component.html',
  styleUrls: ['./biologie-list-chercheur.component.css']
})
export class BiologieListChercheurComponent implements OnInit {
   // declarations
