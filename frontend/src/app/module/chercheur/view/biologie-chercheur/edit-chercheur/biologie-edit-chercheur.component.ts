...
@Component({
  selector: 'app-biologie-edit-chercheur',
  templateUrl: './biologie-edit-chercheur.component.html',
  styleUrls: ['./biologie-edit-chercheur.component.css']
})
export class BiologieEditChercheurComponent implements OnInit {
