...
@Component({
  selector: 'app-dossier-medicale-tag-create-chercheur',
  templateUrl: './dossier-medicale-tag-create-chercheur.component.html',
  styleUrls: ['./dossier-medicale-tag-create-chercheur.component.css']
})
export class DossierMedicaleTagCreateChercheurComponent implements OnInit {
