...
@Component({
  selector: 'app-dossier-medicale-tag-view-chercheur',
  templateUrl: './dossier-medicale-tag-view-chercheur.component.html',
  styleUrls: ['./dossier-medicale-tag-view-chercheur.component.css']
})
export class DossierMedicaleTagViewChercheurComponent implements OnInit {
