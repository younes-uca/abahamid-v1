...
@Component({
  selector: 'app-dossier-medicale-tag-edit-chercheur',
  templateUrl: './dossier-medicale-tag-edit-chercheur.component.html',
  styleUrls: ['./dossier-medicale-tag-edit-chercheur.component.css']
})
export class DossierMedicaleTagEditChercheurComponent implements OnInit {
