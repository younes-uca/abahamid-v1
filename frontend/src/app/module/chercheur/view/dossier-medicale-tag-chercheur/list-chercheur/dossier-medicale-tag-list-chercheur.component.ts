...
@Component({
  selector: 'app-dossier-medicale-tag-list-chercheur',
  templateUrl: './dossier-medicale-tag-list-chercheur.component.html',
  styleUrls: ['./dossier-medicale-tag-list-chercheur.component.css']
})
export class DossierMedicaleTagListChercheurComponent implements OnInit {
   // declarations
