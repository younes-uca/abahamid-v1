...
@Component({
  selector: 'app-soin-list-chercheur',
  templateUrl: './soin-list-chercheur.component.html',
  styleUrls: ['./soin-list-chercheur.component.css']
})
export class SoinListChercheurComponent implements OnInit {
   // declarations
