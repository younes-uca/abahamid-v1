...
@Component({
  selector: 'app-soin-create-chercheur',
  templateUrl: './soin-create-chercheur.component.html',
  styleUrls: ['./soin-create-chercheur.component.css']
})
export class SoinCreateChercheurComponent implements OnInit {
