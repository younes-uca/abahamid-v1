...
@Component({
  selector: 'app-soin-view-chercheur',
  templateUrl: './soin-view-chercheur.component.html',
  styleUrls: ['./soin-view-chercheur.component.css']
})
export class SoinViewChercheurComponent implements OnInit {
