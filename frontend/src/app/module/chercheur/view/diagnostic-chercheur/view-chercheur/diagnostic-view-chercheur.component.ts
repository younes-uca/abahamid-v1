...
@Component({
  selector: 'app-diagnostic-view-chercheur',
  templateUrl: './diagnostic-view-chercheur.component.html',
  styleUrls: ['./diagnostic-view-chercheur.component.css']
})
export class DiagnosticViewChercheurComponent implements OnInit {
