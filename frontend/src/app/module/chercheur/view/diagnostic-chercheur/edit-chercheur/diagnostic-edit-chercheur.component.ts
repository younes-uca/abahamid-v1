...
@Component({
  selector: 'app-diagnostic-edit-chercheur',
  templateUrl: './diagnostic-edit-chercheur.component.html',
  styleUrls: ['./diagnostic-edit-chercheur.component.css']
})
export class DiagnosticEditChercheurComponent implements OnInit {
