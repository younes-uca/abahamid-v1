...
@Component({
  selector: 'app-evo-suiv-edit-chercheur',
  templateUrl: './evo-suiv-edit-chercheur.component.html',
  styleUrls: ['./evo-suiv-edit-chercheur.component.css']
})
export class EvoSuivEditChercheurComponent implements OnInit {
