...
@Component({
  selector: 'app-evo-suiv-create-chercheur',
  templateUrl: './evo-suiv-create-chercheur.component.html',
  styleUrls: ['./evo-suiv-create-chercheur.component.css']
})
export class EvoSuivCreateChercheurComponent implements OnInit {
