...
@Component({
  selector: 'app-recueil-de-donnes-create-chercheur',
  templateUrl: './recueil-de-donnes-create-chercheur.component.html',
  styleUrls: ['./recueil-de-donnes-create-chercheur.component.css']
})
export class RecueilDeDonnesCreateChercheurComponent implements OnInit {
