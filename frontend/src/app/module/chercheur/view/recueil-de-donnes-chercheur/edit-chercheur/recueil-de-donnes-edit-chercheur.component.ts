...
@Component({
  selector: 'app-recueil-de-donnes-edit-chercheur',
  templateUrl: './recueil-de-donnes-edit-chercheur.component.html',
  styleUrls: ['./recueil-de-donnes-edit-chercheur.component.css']
})
export class RecueilDeDonnesEditChercheurComponent implements OnInit {
