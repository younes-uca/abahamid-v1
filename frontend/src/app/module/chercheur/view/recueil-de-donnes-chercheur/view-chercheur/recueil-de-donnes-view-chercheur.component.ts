...
@Component({
  selector: 'app-recueil-de-donnes-view-chercheur',
  templateUrl: './recueil-de-donnes-view-chercheur.component.html',
  styleUrls: ['./recueil-de-donnes-view-chercheur.component.css']
})
export class RecueilDeDonnesViewChercheurComponent implements OnInit {
