...
@Component({
  selector: 'app-imagerie-view-chercheur',
  templateUrl: './imagerie-view-chercheur.component.html',
  styleUrls: ['./imagerie-view-chercheur.component.css']
})
export class ImagerieViewChercheurComponent implements OnInit {
