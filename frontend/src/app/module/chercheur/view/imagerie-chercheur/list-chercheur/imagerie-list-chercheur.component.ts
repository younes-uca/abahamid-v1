...
@Component({
  selector: 'app-imagerie-list-chercheur',
  templateUrl: './imagerie-list-chercheur.component.html',
  styleUrls: ['./imagerie-list-chercheur.component.css']
})
export class ImagerieListChercheurComponent implements OnInit {
   // declarations
