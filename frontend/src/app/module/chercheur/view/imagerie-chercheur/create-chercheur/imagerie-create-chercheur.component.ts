...
@Component({
  selector: 'app-imagerie-create-chercheur',
  templateUrl: './imagerie-create-chercheur.component.html',
  styleUrls: ['./imagerie-create-chercheur.component.css']
})
export class ImagerieCreateChercheurComponent implements OnInit {
