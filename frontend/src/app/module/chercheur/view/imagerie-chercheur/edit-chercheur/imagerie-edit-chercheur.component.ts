...
@Component({
  selector: 'app-imagerie-edit-chercheur',
  templateUrl: './imagerie-edit-chercheur.component.html',
  styleUrls: ['./imagerie-edit-chercheur.component.css']
})
export class ImagerieEditChercheurComponent implements OnInit {
