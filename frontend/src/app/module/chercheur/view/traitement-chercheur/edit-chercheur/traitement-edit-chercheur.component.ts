...
@Component({
  selector: 'app-traitement-edit-chercheur',
  templateUrl: './traitement-edit-chercheur.component.html',
  styleUrls: ['./traitement-edit-chercheur.component.css']
})
export class TraitementEditChercheurComponent implements OnInit {
