...
@Component({
  selector: 'app-sexe-create-chercheur',
  templateUrl: './sexe-create-chercheur.component.html',
  styleUrls: ['./sexe-create-chercheur.component.css']
})
export class SexeCreateChercheurComponent implements OnInit {
