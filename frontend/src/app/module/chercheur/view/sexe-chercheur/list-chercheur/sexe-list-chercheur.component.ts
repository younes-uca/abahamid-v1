...
@Component({
  selector: 'app-sexe-list-chercheur',
  templateUrl: './sexe-list-chercheur.component.html',
  styleUrls: ['./sexe-list-chercheur.component.css']
})
export class SexeListChercheurComponent implements OnInit {
   // declarations
