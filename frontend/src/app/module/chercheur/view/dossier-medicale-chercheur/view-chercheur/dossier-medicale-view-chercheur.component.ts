...
@Component({
  selector: 'app-dossier-medicale-view-chercheur',
  templateUrl: './dossier-medicale-view-chercheur.component.html',
  styleUrls: ['./dossier-medicale-view-chercheur.component.css']
})
export class DossierMedicaleViewChercheurComponent implements OnInit {
