...
@Component({
  selector: 'app-dossier-medicale-list-chercheur',
  templateUrl: './dossier-medicale-list-chercheur.component.html',
  styleUrls: ['./dossier-medicale-list-chercheur.component.css']
})
export class DossierMedicaleListChercheurComponent implements OnInit {
   // declarations
