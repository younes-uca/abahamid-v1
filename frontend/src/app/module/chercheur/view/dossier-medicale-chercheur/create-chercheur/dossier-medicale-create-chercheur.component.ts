...
@Component({
  selector: 'app-dossier-medicale-create-chercheur',
  templateUrl: './dossier-medicale-create-chercheur.component.html',
  styleUrls: ['./dossier-medicale-create-chercheur.component.css']
})
export class DossierMedicaleCreateChercheurComponent implements OnInit {
