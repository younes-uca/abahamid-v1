...
@Component({
  selector: 'app-relation-view-chercheur',
  templateUrl: './relation-view-chercheur.component.html',
  styleUrls: ['./relation-view-chercheur.component.css']
})
export class RelationViewChercheurComponent implements OnInit {
