...
@Component({
  selector: 'app-relation-edit-chercheur',
  templateUrl: './relation-edit-chercheur.component.html',
  styleUrls: ['./relation-edit-chercheur.component.css']
})
export class RelationEditChercheurComponent implements OnInit {
