...
@Component({
  selector: 'app-relation-list-chercheur',
  templateUrl: './relation-list-chercheur.component.html',
  styleUrls: ['./relation-list-chercheur.component.css']
})
export class RelationListChercheurComponent implements OnInit {
   // declarations
