...
@Component({
  selector: 'app-clinique-list-chercheur',
  templateUrl: './clinique-list-chercheur.component.html',
  styleUrls: ['./clinique-list-chercheur.component.css']
})
export class CliniqueListChercheurComponent implements OnInit {
   // declarations
