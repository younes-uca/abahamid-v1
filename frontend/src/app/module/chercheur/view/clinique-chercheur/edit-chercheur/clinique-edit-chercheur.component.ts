...
@Component({
  selector: 'app-clinique-edit-chercheur',
  templateUrl: './clinique-edit-chercheur.component.html',
  styleUrls: ['./clinique-edit-chercheur.component.css']
})
export class CliniqueEditChercheurComponent implements OnInit {
