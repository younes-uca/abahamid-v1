...
@Component({
  selector: 'app-infirmier-view-chercheur',
  templateUrl: './infirmier-view-chercheur.component.html',
  styleUrls: ['./infirmier-view-chercheur.component.css']
})
export class InfirmierViewChercheurComponent implements OnInit {
