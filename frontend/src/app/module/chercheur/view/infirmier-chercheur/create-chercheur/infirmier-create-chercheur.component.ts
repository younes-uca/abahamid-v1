...
@Component({
  selector: 'app-infirmier-create-chercheur',
  templateUrl: './infirmier-create-chercheur.component.html',
  styleUrls: ['./infirmier-create-chercheur.component.css']
})
export class InfirmierCreateChercheurComponent implements OnInit {
