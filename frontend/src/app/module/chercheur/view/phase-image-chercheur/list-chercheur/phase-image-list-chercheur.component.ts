...
@Component({
  selector: 'app-phase-image-list-chercheur',
  templateUrl: './phase-image-list-chercheur.component.html',
  styleUrls: ['./phase-image-list-chercheur.component.css']
})
export class PhaseImageListChercheurComponent implements OnInit {
   // declarations
