...
@Component({
  selector: 'app-phase-image-create-chercheur',
  templateUrl: './phase-image-create-chercheur.component.html',
  styleUrls: ['./phase-image-create-chercheur.component.css']
})
export class PhaseImageCreateChercheurComponent implements OnInit {
