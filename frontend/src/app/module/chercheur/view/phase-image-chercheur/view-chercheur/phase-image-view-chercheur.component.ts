...
@Component({
  selector: 'app-phase-image-view-chercheur',
  templateUrl: './phase-image-view-chercheur.component.html',
  styleUrls: ['./phase-image-view-chercheur.component.css']
})
export class PhaseImageViewChercheurComponent implements OnInit {
