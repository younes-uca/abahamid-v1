...
@Component({
  selector: 'app-patient-contact-view-chercheur',
  templateUrl: './patient-contact-view-chercheur.component.html',
  styleUrls: ['./patient-contact-view-chercheur.component.css']
})
export class PatientContactViewChercheurComponent implements OnInit {
