...
@Component({
  selector: 'app-patient-contact-edit-chercheur',
  templateUrl: './patient-contact-edit-chercheur.component.html',
  styleUrls: ['./patient-contact-edit-chercheur.component.css']
})
export class PatientContactEditChercheurComponent implements OnInit {
