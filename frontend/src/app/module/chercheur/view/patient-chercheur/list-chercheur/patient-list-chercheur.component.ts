...
@Component({
  selector: 'app-patient-list-chercheur',
  templateUrl: './patient-list-chercheur.component.html',
  styleUrls: ['./patient-list-chercheur.component.css']
})
export class PatientListChercheurComponent implements OnInit {
   // declarations
