...
@Component({
  selector: 'app-patient-create-chercheur',
  templateUrl: './patient-create-chercheur.component.html',
  styleUrls: ['./patient-create-chercheur.component.css']
})
export class PatientCreateChercheurComponent implements OnInit {
