...
@Component({
  selector: 'app-patient-edit-chercheur',
  templateUrl: './patient-edit-chercheur.component.html',
  styleUrls: ['./patient-edit-chercheur.component.css']
})
export class PatientEditChercheurComponent implements OnInit {
