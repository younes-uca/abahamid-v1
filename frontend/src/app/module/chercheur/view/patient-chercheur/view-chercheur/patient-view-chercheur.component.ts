...
@Component({
  selector: 'app-patient-view-chercheur',
  templateUrl: './patient-view-chercheur.component.html',
  styleUrls: ['./patient-view-chercheur.component.css']
})
export class PatientViewChercheurComponent implements OnInit {
