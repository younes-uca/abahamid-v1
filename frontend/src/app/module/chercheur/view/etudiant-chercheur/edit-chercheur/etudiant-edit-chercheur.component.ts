...
@Component({
  selector: 'app-etudiant-edit-chercheur',
  templateUrl: './etudiant-edit-chercheur.component.html',
  styleUrls: ['./etudiant-edit-chercheur.component.css']
})
export class EtudiantEditChercheurComponent implements OnInit {
