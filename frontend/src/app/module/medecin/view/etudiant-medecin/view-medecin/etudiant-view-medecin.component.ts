...
@Component({
  selector: 'app-etudiant-view-medecin',
  templateUrl: './etudiant-view-medecin.component.html',
  styleUrls: ['./etudiant-view-medecin.component.css']
})
export class EtudiantViewMedecinComponent implements OnInit {
