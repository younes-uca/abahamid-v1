...
@Component({
  selector: 'app-etudiant-create-medecin',
  templateUrl: './etudiant-create-medecin.component.html',
  styleUrls: ['./etudiant-create-medecin.component.css']
})
export class EtudiantCreateMedecinComponent implements OnInit {
