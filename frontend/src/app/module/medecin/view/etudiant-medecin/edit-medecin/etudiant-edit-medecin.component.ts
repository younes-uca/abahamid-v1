...
@Component({
  selector: 'app-etudiant-edit-medecin',
  templateUrl: './etudiant-edit-medecin.component.html',
  styleUrls: ['./etudiant-edit-medecin.component.css']
})
export class EtudiantEditMedecinComponent implements OnInit {
