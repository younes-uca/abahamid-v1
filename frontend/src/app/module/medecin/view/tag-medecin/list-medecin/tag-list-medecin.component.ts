...
@Component({
  selector: 'app-tag-list-medecin',
  templateUrl: './tag-list-medecin.component.html',
  styleUrls: ['./tag-list-medecin.component.css']
})
export class TagListMedecinComponent implements OnInit {
   // declarations
