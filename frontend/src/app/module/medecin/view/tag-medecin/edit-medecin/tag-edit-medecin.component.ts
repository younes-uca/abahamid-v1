...
@Component({
  selector: 'app-tag-edit-medecin',
  templateUrl: './tag-edit-medecin.component.html',
  styleUrls: ['./tag-edit-medecin.component.css']
})
export class TagEditMedecinComponent implements OnInit {
