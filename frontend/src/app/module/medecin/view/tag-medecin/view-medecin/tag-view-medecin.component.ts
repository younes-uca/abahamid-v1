...
@Component({
  selector: 'app-tag-view-medecin',
  templateUrl: './tag-view-medecin.component.html',
  styleUrls: ['./tag-view-medecin.component.css']
})
export class TagViewMedecinComponent implements OnInit {
