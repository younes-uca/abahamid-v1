...
@Component({
  selector: 'app-tag-create-medecin',
  templateUrl: './tag-create-medecin.component.html',
  styleUrls: ['./tag-create-medecin.component.css']
})
export class TagCreateMedecinComponent implements OnInit {
