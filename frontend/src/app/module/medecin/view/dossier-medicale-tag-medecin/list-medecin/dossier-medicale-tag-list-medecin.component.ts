...
@Component({
  selector: 'app-dossier-medicale-tag-list-medecin',
  templateUrl: './dossier-medicale-tag-list-medecin.component.html',
  styleUrls: ['./dossier-medicale-tag-list-medecin.component.css']
})
export class DossierMedicaleTagListMedecinComponent implements OnInit {
   // declarations
