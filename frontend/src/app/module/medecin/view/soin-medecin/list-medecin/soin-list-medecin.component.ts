...
@Component({
  selector: 'app-soin-list-medecin',
  templateUrl: './soin-list-medecin.component.html',
  styleUrls: ['./soin-list-medecin.component.css']
})
export class SoinListMedecinComponent implements OnInit {
   // declarations
