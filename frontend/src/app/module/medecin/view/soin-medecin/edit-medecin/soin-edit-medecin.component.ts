...
@Component({
  selector: 'app-soin-edit-medecin',
  templateUrl: './soin-edit-medecin.component.html',
  styleUrls: ['./soin-edit-medecin.component.css']
})
export class SoinEditMedecinComponent implements OnInit {
