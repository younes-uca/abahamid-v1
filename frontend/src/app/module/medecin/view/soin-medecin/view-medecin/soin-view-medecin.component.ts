...
@Component({
  selector: 'app-soin-view-medecin',
  templateUrl: './soin-view-medecin.component.html',
  styleUrls: ['./soin-view-medecin.component.css']
})
export class SoinViewMedecinComponent implements OnInit {
