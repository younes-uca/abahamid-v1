...
@Component({
  selector: 'app-recueil-de-donnes-edit-medecin',
  templateUrl: './recueil-de-donnes-edit-medecin.component.html',
  styleUrls: ['./recueil-de-donnes-edit-medecin.component.css']
})
export class RecueilDeDonnesEditMedecinComponent implements OnInit {
