...
@Component({
  selector: 'app-recueil-de-donnes-list-medecin',
  templateUrl: './recueil-de-donnes-list-medecin.component.html',
  styleUrls: ['./recueil-de-donnes-list-medecin.component.css']
})
export class RecueilDeDonnesListMedecinComponent implements OnInit {
   // declarations
