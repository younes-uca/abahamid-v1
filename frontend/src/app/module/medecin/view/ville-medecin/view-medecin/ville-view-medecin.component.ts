...
@Component({
  selector: 'app-ville-view-medecin',
  templateUrl: './ville-view-medecin.component.html',
  styleUrls: ['./ville-view-medecin.component.css']
})
export class VilleViewMedecinComponent implements OnInit {
