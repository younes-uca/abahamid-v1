...
@Component({
  selector: 'app-ville-edit-medecin',
  templateUrl: './ville-edit-medecin.component.html',
  styleUrls: ['./ville-edit-medecin.component.css']
})
export class VilleEditMedecinComponent implements OnInit {
