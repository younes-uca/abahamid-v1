...
@Component({
  selector: 'app-ville-create-medecin',
  templateUrl: './ville-create-medecin.component.html',
  styleUrls: ['./ville-create-medecin.component.css']
})
export class VilleCreateMedecinComponent implements OnInit {
