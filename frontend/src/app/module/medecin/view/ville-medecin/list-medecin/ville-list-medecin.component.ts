...
@Component({
  selector: 'app-ville-list-medecin',
  templateUrl: './ville-list-medecin.component.html',
  styleUrls: ['./ville-list-medecin.component.css']
})
export class VilleListMedecinComponent implements OnInit {
   // declarations
