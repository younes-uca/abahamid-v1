...
@Component({
  selector: 'app-clinique-create-medecin',
  templateUrl: './clinique-create-medecin.component.html',
  styleUrls: ['./clinique-create-medecin.component.css']
})
export class CliniqueCreateMedecinComponent implements OnInit {
