...
@Component({
  selector: 'app-clinique-edit-medecin',
  templateUrl: './clinique-edit-medecin.component.html',
  styleUrls: ['./clinique-edit-medecin.component.css']
})
export class CliniqueEditMedecinComponent implements OnInit {
