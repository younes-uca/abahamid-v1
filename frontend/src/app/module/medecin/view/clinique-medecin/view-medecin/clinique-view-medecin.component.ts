...
@Component({
  selector: 'app-clinique-view-medecin',
  templateUrl: './clinique-view-medecin.component.html',
  styleUrls: ['./clinique-view-medecin.component.css']
})
export class CliniqueViewMedecinComponent implements OnInit {
