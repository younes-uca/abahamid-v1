...
@Component({
  selector: 'app-compte-rendu-list-medecin',
  templateUrl: './compte-rendu-list-medecin.component.html',
  styleUrls: ['./compte-rendu-list-medecin.component.css']
})
export class CompteRenduListMedecinComponent implements OnInit {
   // declarations
