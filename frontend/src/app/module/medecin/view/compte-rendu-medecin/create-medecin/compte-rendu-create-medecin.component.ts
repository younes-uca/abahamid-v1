...
@Component({
  selector: 'app-compte-rendu-create-medecin',
  templateUrl: './compte-rendu-create-medecin.component.html',
  styleUrls: ['./compte-rendu-create-medecin.component.css']
})
export class CompteRenduCreateMedecinComponent implements OnInit {
