...
@Component({
  selector: 'app-compte-rendu-view-medecin',
  templateUrl: './compte-rendu-view-medecin.component.html',
  styleUrls: ['./compte-rendu-view-medecin.component.css']
})
export class CompteRenduViewMedecinComponent implements OnInit {
