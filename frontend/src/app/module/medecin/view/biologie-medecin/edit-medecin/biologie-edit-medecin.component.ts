...
@Component({
  selector: 'app-biologie-edit-medecin',
  templateUrl: './biologie-edit-medecin.component.html',
  styleUrls: ['./biologie-edit-medecin.component.css']
})
export class BiologieEditMedecinComponent implements OnInit {
