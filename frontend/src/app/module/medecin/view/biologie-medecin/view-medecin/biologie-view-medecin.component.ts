...
@Component({
  selector: 'app-biologie-view-medecin',
  templateUrl: './biologie-view-medecin.component.html',
  styleUrls: ['./biologie-view-medecin.component.css']
})
export class BiologieViewMedecinComponent implements OnInit {
