...
@Component({
  selector: 'app-biologie-create-medecin',
  templateUrl: './biologie-create-medecin.component.html',
  styleUrls: ['./biologie-create-medecin.component.css']
})
export class BiologieCreateMedecinComponent implements OnInit {
