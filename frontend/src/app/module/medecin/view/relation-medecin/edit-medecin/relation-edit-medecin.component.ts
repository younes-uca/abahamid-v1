...
@Component({
  selector: 'app-relation-edit-medecin',
  templateUrl: './relation-edit-medecin.component.html',
  styleUrls: ['./relation-edit-medecin.component.css']
})
export class RelationEditMedecinComponent implements OnInit {
