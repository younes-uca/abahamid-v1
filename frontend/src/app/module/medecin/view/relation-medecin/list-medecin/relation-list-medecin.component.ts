...
@Component({
  selector: 'app-relation-list-medecin',
  templateUrl: './relation-list-medecin.component.html',
  styleUrls: ['./relation-list-medecin.component.css']
})
export class RelationListMedecinComponent implements OnInit {
   // declarations
