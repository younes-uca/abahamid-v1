...
@Component({
  selector: 'app-patient-contact-view-medecin',
  templateUrl: './patient-contact-view-medecin.component.html',
  styleUrls: ['./patient-contact-view-medecin.component.css']
})
export class PatientContactViewMedecinComponent implements OnInit {
