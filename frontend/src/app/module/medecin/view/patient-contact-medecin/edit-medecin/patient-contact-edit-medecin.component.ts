...
@Component({
  selector: 'app-patient-contact-edit-medecin',
  templateUrl: './patient-contact-edit-medecin.component.html',
  styleUrls: ['./patient-contact-edit-medecin.component.css']
})
export class PatientContactEditMedecinComponent implements OnInit {
