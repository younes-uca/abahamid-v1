...
@Component({
  selector: 'app-patient-contact-create-medecin',
  templateUrl: './patient-contact-create-medecin.component.html',
  styleUrls: ['./patient-contact-create-medecin.component.css']
})
export class PatientContactCreateMedecinComponent implements OnInit {
