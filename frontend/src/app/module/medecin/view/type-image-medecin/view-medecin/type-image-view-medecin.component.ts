...
@Component({
  selector: 'app-type-image-view-medecin',
  templateUrl: './type-image-view-medecin.component.html',
  styleUrls: ['./type-image-view-medecin.component.css']
})
export class TypeImageViewMedecinComponent implements OnInit {
