...
@Component({
  selector: 'app-type-image-create-medecin',
  templateUrl: './type-image-create-medecin.component.html',
  styleUrls: ['./type-image-create-medecin.component.css']
})
export class TypeImageCreateMedecinComponent implements OnInit {
