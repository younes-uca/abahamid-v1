...
@Component({
  selector: 'app-type-image-edit-medecin',
  templateUrl: './type-image-edit-medecin.component.html',
  styleUrls: ['./type-image-edit-medecin.component.css']
})
export class TypeImageEditMedecinComponent implements OnInit {
