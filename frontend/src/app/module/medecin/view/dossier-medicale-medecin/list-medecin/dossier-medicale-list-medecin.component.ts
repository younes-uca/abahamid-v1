...
@Component({
  selector: 'app-dossier-medicale-list-medecin',
  templateUrl: './dossier-medicale-list-medecin.component.html',
  styleUrls: ['./dossier-medicale-list-medecin.component.css']
})
export class DossierMedicaleListMedecinComponent implements OnInit {
   // declarations
