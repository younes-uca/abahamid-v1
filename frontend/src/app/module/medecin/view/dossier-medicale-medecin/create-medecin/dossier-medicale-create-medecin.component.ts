...
@Component({
  selector: 'app-dossier-medicale-create-medecin',
  templateUrl: './dossier-medicale-create-medecin.component.html',
  styleUrls: ['./dossier-medicale-create-medecin.component.css']
})
export class DossierMedicaleCreateMedecinComponent implements OnInit {
