...
@Component({
  selector: 'app-dossier-medicale-edit-medecin',
  templateUrl: './dossier-medicale-edit-medecin.component.html',
  styleUrls: ['./dossier-medicale-edit-medecin.component.css']
})
export class DossierMedicaleEditMedecinComponent implements OnInit {
