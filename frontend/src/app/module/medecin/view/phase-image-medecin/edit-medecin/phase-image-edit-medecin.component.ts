...
@Component({
  selector: 'app-phase-image-edit-medecin',
  templateUrl: './phase-image-edit-medecin.component.html',
  styleUrls: ['./phase-image-edit-medecin.component.css']
})
export class PhaseImageEditMedecinComponent implements OnInit {
