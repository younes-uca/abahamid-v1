...
@Component({
  selector: 'app-phase-image-list-medecin',
  templateUrl: './phase-image-list-medecin.component.html',
  styleUrls: ['./phase-image-list-medecin.component.css']
})
export class PhaseImageListMedecinComponent implements OnInit {
   // declarations
