...
@Component({
  selector: 'app-examen-edit-medecin',
  templateUrl: './examen-edit-medecin.component.html',
  styleUrls: ['./examen-edit-medecin.component.css']
})
export class ExamenEditMedecinComponent implements OnInit {
