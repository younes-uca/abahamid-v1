...
@Component({
  selector: 'app-examen-list-medecin',
  templateUrl: './examen-list-medecin.component.html',
  styleUrls: ['./examen-list-medecin.component.css']
})
export class ExamenListMedecinComponent implements OnInit {
   // declarations
