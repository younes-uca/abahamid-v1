...
@Component({
  selector: 'app-examen-create-medecin',
  templateUrl: './examen-create-medecin.component.html',
  styleUrls: ['./examen-create-medecin.component.css']
})
export class ExamenCreateMedecinComponent implements OnInit {
