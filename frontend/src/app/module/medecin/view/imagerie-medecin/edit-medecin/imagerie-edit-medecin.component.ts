...
@Component({
  selector: 'app-imagerie-edit-medecin',
  templateUrl: './imagerie-edit-medecin.component.html',
  styleUrls: ['./imagerie-edit-medecin.component.css']
})
export class ImagerieEditMedecinComponent implements OnInit {
