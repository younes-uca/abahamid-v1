...
@Component({
  selector: 'app-imagerie-list-medecin',
  templateUrl: './imagerie-list-medecin.component.html',
  styleUrls: ['./imagerie-list-medecin.component.css']
})
export class ImagerieListMedecinComponent implements OnInit {
   // declarations
