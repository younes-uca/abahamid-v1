...
@Component({
  selector: 'app-infirmier-view-medecin',
  templateUrl: './infirmier-view-medecin.component.html',
  styleUrls: ['./infirmier-view-medecin.component.css']
})
export class InfirmierViewMedecinComponent implements OnInit {
