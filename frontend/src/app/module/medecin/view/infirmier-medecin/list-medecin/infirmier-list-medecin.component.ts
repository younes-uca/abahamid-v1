...
@Component({
  selector: 'app-infirmier-list-medecin',
  templateUrl: './infirmier-list-medecin.component.html',
  styleUrls: ['./infirmier-list-medecin.component.css']
})
export class InfirmierListMedecinComponent implements OnInit {
   // declarations
