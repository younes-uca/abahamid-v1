...
@Component({
  selector: 'app-infirmier-create-medecin',
  templateUrl: './infirmier-create-medecin.component.html',
  styleUrls: ['./infirmier-create-medecin.component.css']
})
export class InfirmierCreateMedecinComponent implements OnInit {
