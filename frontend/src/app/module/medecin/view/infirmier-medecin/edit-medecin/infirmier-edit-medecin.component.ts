...
@Component({
  selector: 'app-infirmier-edit-medecin',
  templateUrl: './infirmier-edit-medecin.component.html',
  styleUrls: ['./infirmier-edit-medecin.component.css']
})
export class InfirmierEditMedecinComponent implements OnInit {
