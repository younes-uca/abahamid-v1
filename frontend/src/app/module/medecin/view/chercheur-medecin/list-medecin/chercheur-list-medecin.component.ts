...
@Component({
  selector: 'app-chercheur-list-medecin',
  templateUrl: './chercheur-list-medecin.component.html',
  styleUrls: ['./chercheur-list-medecin.component.css']
})
export class ChercheurListMedecinComponent implements OnInit {
   // declarations
