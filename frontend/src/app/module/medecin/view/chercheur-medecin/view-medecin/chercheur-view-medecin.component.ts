...
@Component({
  selector: 'app-chercheur-view-medecin',
  templateUrl: './chercheur-view-medecin.component.html',
  styleUrls: ['./chercheur-view-medecin.component.css']
})
export class ChercheurViewMedecinComponent implements OnInit {
