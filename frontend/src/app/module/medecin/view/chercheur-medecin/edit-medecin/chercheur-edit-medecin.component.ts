...
@Component({
  selector: 'app-chercheur-edit-medecin',
  templateUrl: './chercheur-edit-medecin.component.html',
  styleUrls: ['./chercheur-edit-medecin.component.css']
})
export class ChercheurEditMedecinComponent implements OnInit {
