...
@Component({
  selector: 'app-medecin-list-medecin',
  templateUrl: './medecin-list-medecin.component.html',
  styleUrls: ['./medecin-list-medecin.component.css']
})
export class MedecinListMedecinComponent implements OnInit {
   // declarations
