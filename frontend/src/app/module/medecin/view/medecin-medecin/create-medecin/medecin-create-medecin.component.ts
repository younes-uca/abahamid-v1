...
@Component({
  selector: 'app-medecin-create-medecin',
  templateUrl: './medecin-create-medecin.component.html',
  styleUrls: ['./medecin-create-medecin.component.css']
})
export class MedecinCreateMedecinComponent implements OnInit {
