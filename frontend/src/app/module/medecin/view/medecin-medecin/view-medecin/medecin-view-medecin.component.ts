...
@Component({
  selector: 'app-medecin-view-medecin',
  templateUrl: './medecin-view-medecin.component.html',
  styleUrls: ['./medecin-view-medecin.component.css']
})
export class MedecinViewMedecinComponent implements OnInit {
