...
@Component({
  selector: 'app-patient-create-medecin',
  templateUrl: './patient-create-medecin.component.html',
  styleUrls: ['./patient-create-medecin.component.css']
})
export class PatientCreateMedecinComponent implements OnInit {
