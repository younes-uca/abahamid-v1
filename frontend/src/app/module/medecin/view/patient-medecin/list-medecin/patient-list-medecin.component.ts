...
@Component({
  selector: 'app-patient-list-medecin',
  templateUrl: './patient-list-medecin.component.html',
  styleUrls: ['./patient-list-medecin.component.css']
})
export class PatientListMedecinComponent implements OnInit {
   // declarations
