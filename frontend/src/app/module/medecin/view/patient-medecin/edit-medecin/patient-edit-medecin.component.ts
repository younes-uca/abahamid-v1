...
@Component({
  selector: 'app-patient-edit-medecin',
  templateUrl: './patient-edit-medecin.component.html',
  styleUrls: ['./patient-edit-medecin.component.css']
})
export class PatientEditMedecinComponent implements OnInit {
