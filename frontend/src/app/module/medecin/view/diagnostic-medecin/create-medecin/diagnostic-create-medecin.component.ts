...
@Component({
  selector: 'app-diagnostic-create-medecin',
  templateUrl: './diagnostic-create-medecin.component.html',
  styleUrls: ['./diagnostic-create-medecin.component.css']
})
export class DiagnosticCreateMedecinComponent implements OnInit {
