...
@Component({
  selector: 'app-diagnostic-list-medecin',
  templateUrl: './diagnostic-list-medecin.component.html',
  styleUrls: ['./diagnostic-list-medecin.component.css']
})
export class DiagnosticListMedecinComponent implements OnInit {
   // declarations
