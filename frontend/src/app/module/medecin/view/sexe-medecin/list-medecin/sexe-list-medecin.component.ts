...
@Component({
  selector: 'app-sexe-list-medecin',
  templateUrl: './sexe-list-medecin.component.html',
  styleUrls: ['./sexe-list-medecin.component.css']
})
export class SexeListMedecinComponent implements OnInit {
   // declarations
