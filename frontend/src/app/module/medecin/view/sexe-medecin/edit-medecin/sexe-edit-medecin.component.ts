...
@Component({
  selector: 'app-sexe-edit-medecin',
  templateUrl: './sexe-edit-medecin.component.html',
  styleUrls: ['./sexe-edit-medecin.component.css']
})
export class SexeEditMedecinComponent implements OnInit {
