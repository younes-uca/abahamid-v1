...
@Component({
  selector: 'app-sexe-view-medecin',
  templateUrl: './sexe-view-medecin.component.html',
  styleUrls: ['./sexe-view-medecin.component.css']
})
export class SexeViewMedecinComponent implements OnInit {
