...
@Component({
  selector: 'app-sexe-create-medecin',
  templateUrl: './sexe-create-medecin.component.html',
  styleUrls: ['./sexe-create-medecin.component.css']
})
export class SexeCreateMedecinComponent implements OnInit {
