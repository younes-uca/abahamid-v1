...
@Component({
  selector: 'app-evo-suiv-view-medecin',
  templateUrl: './evo-suiv-view-medecin.component.html',
  styleUrls: ['./evo-suiv-view-medecin.component.css']
})
export class EvoSuivViewMedecinComponent implements OnInit {
