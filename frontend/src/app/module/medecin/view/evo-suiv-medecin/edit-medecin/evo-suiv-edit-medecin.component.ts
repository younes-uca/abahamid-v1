...
@Component({
  selector: 'app-evo-suiv-edit-medecin',
  templateUrl: './evo-suiv-edit-medecin.component.html',
  styleUrls: ['./evo-suiv-edit-medecin.component.css']
})
export class EvoSuivEditMedecinComponent implements OnInit {
