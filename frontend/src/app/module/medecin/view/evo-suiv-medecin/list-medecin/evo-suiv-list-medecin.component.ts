...
@Component({
  selector: 'app-evo-suiv-list-medecin',
  templateUrl: './evo-suiv-list-medecin.component.html',
  styleUrls: ['./evo-suiv-list-medecin.component.css']
})
export class EvoSuivListMedecinComponent implements OnInit {
   // declarations
