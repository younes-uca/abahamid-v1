...
@Component({
  selector: 'app-traitement-edit-medecin',
  templateUrl: './traitement-edit-medecin.component.html',
  styleUrls: ['./traitement-edit-medecin.component.css']
})
export class TraitementEditMedecinComponent implements OnInit {
