...
@Component({
  selector: 'app-traitement-list-medecin',
  templateUrl: './traitement-list-medecin.component.html',
  styleUrls: ['./traitement-list-medecin.component.css']
})
export class TraitementListMedecinComponent implements OnInit {
   // declarations
