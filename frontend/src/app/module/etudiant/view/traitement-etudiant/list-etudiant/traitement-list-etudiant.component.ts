...
@Component({
  selector: 'app-traitement-list-etudiant',
  templateUrl: './traitement-list-etudiant.component.html',
  styleUrls: ['./traitement-list-etudiant.component.css']
})
export class TraitementListEtudiantComponent implements OnInit {
   // declarations
