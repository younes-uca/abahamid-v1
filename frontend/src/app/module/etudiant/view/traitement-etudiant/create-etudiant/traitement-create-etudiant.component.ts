...
@Component({
  selector: 'app-traitement-create-etudiant',
  templateUrl: './traitement-create-etudiant.component.html',
  styleUrls: ['./traitement-create-etudiant.component.css']
})
export class TraitementCreateEtudiantComponent implements OnInit {
