...
@Component({
  selector: 'app-traitement-view-etudiant',
  templateUrl: './traitement-view-etudiant.component.html',
  styleUrls: ['./traitement-view-etudiant.component.css']
})
export class TraitementViewEtudiantComponent implements OnInit {
