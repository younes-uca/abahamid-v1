...
@Component({
  selector: 'app-patient-list-etudiant',
  templateUrl: './patient-list-etudiant.component.html',
  styleUrls: ['./patient-list-etudiant.component.css']
})
export class PatientListEtudiantComponent implements OnInit {
   // declarations
