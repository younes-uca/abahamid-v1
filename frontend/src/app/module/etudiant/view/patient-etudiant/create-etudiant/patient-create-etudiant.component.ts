...
@Component({
  selector: 'app-patient-create-etudiant',
  templateUrl: './patient-create-etudiant.component.html',
  styleUrls: ['./patient-create-etudiant.component.css']
})
export class PatientCreateEtudiantComponent implements OnInit {
