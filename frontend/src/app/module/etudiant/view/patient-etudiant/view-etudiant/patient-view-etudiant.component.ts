...
@Component({
  selector: 'app-patient-view-etudiant',
  templateUrl: './patient-view-etudiant.component.html',
  styleUrls: ['./patient-view-etudiant.component.css']
})
export class PatientViewEtudiantComponent implements OnInit {
