...
@Component({
  selector: 'app-type-image-view-etudiant',
  templateUrl: './type-image-view-etudiant.component.html',
  styleUrls: ['./type-image-view-etudiant.component.css']
})
export class TypeImageViewEtudiantComponent implements OnInit {
