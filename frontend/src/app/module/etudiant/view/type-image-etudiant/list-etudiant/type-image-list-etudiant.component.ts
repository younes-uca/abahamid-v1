...
@Component({
  selector: 'app-type-image-list-etudiant',
  templateUrl: './type-image-list-etudiant.component.html',
  styleUrls: ['./type-image-list-etudiant.component.css']
})
export class TypeImageListEtudiantComponent implements OnInit {
   // declarations
