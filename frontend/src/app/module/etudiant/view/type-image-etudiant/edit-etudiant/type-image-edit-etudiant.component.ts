...
@Component({
  selector: 'app-type-image-edit-etudiant',
  templateUrl: './type-image-edit-etudiant.component.html',
  styleUrls: ['./type-image-edit-etudiant.component.css']
})
export class TypeImageEditEtudiantComponent implements OnInit {
