...
@Component({
  selector: 'app-type-image-create-etudiant',
  templateUrl: './type-image-create-etudiant.component.html',
  styleUrls: ['./type-image-create-etudiant.component.css']
})
export class TypeImageCreateEtudiantComponent implements OnInit {
