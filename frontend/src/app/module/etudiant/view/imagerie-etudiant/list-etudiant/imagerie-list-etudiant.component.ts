...
@Component({
  selector: 'app-imagerie-list-etudiant',
  templateUrl: './imagerie-list-etudiant.component.html',
  styleUrls: ['./imagerie-list-etudiant.component.css']
})
export class ImagerieListEtudiantComponent implements OnInit {
   // declarations
