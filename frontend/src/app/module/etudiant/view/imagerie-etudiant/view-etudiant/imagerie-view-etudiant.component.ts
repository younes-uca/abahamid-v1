...
@Component({
  selector: 'app-imagerie-view-etudiant',
  templateUrl: './imagerie-view-etudiant.component.html',
  styleUrls: ['./imagerie-view-etudiant.component.css']
})
export class ImagerieViewEtudiantComponent implements OnInit {
