...
@Component({
  selector: 'app-imagerie-create-etudiant',
  templateUrl: './imagerie-create-etudiant.component.html',
  styleUrls: ['./imagerie-create-etudiant.component.css']
})
export class ImagerieCreateEtudiantComponent implements OnInit {
