...
@Component({
  selector: 'app-imagerie-edit-etudiant',
  templateUrl: './imagerie-edit-etudiant.component.html',
  styleUrls: ['./imagerie-edit-etudiant.component.css']
})
export class ImagerieEditEtudiantComponent implements OnInit {
