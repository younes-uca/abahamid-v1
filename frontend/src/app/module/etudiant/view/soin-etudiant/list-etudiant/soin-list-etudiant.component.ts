...
@Component({
  selector: 'app-soin-list-etudiant',
  templateUrl: './soin-list-etudiant.component.html',
  styleUrls: ['./soin-list-etudiant.component.css']
})
export class SoinListEtudiantComponent implements OnInit {
   // declarations
