...
@Component({
  selector: 'app-soin-create-etudiant',
  templateUrl: './soin-create-etudiant.component.html',
  styleUrls: ['./soin-create-etudiant.component.css']
})
export class SoinCreateEtudiantComponent implements OnInit {
