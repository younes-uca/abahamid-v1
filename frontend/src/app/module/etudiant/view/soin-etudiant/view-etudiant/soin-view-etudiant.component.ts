...
@Component({
  selector: 'app-soin-view-etudiant',
  templateUrl: './soin-view-etudiant.component.html',
  styleUrls: ['./soin-view-etudiant.component.css']
})
export class SoinViewEtudiantComponent implements OnInit {
