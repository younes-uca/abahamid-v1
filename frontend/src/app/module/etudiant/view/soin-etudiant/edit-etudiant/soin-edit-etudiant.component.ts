...
@Component({
  selector: 'app-soin-edit-etudiant',
  templateUrl: './soin-edit-etudiant.component.html',
  styleUrls: ['./soin-edit-etudiant.component.css']
})
export class SoinEditEtudiantComponent implements OnInit {
