...
@Component({
  selector: 'app-diagnostic-list-etudiant',
  templateUrl: './diagnostic-list-etudiant.component.html',
  styleUrls: ['./diagnostic-list-etudiant.component.css']
})
export class DiagnosticListEtudiantComponent implements OnInit {
   // declarations
