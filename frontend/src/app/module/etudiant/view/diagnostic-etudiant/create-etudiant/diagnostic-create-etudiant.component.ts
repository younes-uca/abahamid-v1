...
@Component({
  selector: 'app-diagnostic-create-etudiant',
  templateUrl: './diagnostic-create-etudiant.component.html',
  styleUrls: ['./diagnostic-create-etudiant.component.css']
})
export class DiagnosticCreateEtudiantComponent implements OnInit {
