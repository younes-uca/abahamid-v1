...
@Component({
  selector: 'app-diagnostic-view-etudiant',
  templateUrl: './diagnostic-view-etudiant.component.html',
  styleUrls: ['./diagnostic-view-etudiant.component.css']
})
export class DiagnosticViewEtudiantComponent implements OnInit {
