...
@Component({
  selector: 'app-tag-create-etudiant',
  templateUrl: './tag-create-etudiant.component.html',
  styleUrls: ['./tag-create-etudiant.component.css']
})
export class TagCreateEtudiantComponent implements OnInit {
...
private validateTagReference(){
        if (this.stringUtilService.isEmpty(this.selectedTag.reference)) {
