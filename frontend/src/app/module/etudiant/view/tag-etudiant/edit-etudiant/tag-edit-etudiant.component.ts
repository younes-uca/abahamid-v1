...
@Component({
  selector: 'app-tag-edit-etudiant',
  templateUrl: './tag-edit-etudiant.component.html',
  styleUrls: ['./tag-edit-etudiant.component.css']
})
export class TagEditEtudiantComponent implements OnInit {
