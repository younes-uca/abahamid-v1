...
@Component({
  selector: 'app-tag-list-etudiant',
  templateUrl: './tag-list-etudiant.component.html',
  styleUrls: ['./tag-list-etudiant.component.css']
})
export class TagListEtudiantComponent implements OnInit {
   // declarations
