...
@Component({
  selector: 'app-sexe-edit-etudiant',
  templateUrl: './sexe-edit-etudiant.component.html',
  styleUrls: ['./sexe-edit-etudiant.component.css']
})
export class SexeEditEtudiantComponent implements OnInit {
