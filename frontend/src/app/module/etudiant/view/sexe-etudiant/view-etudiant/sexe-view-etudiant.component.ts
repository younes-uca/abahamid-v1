...
@Component({
  selector: 'app-sexe-view-etudiant',
  templateUrl: './sexe-view-etudiant.component.html',
  styleUrls: ['./sexe-view-etudiant.component.css']
})
export class SexeViewEtudiantComponent implements OnInit {
