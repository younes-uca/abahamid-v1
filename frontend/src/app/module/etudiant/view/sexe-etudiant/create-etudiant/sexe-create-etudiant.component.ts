...
@Component({
  selector: 'app-sexe-create-etudiant',
  templateUrl: './sexe-create-etudiant.component.html',
  styleUrls: ['./sexe-create-etudiant.component.css']
})
export class SexeCreateEtudiantComponent implements OnInit {
