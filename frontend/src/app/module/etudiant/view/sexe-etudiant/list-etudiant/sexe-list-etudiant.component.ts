...
@Component({
  selector: 'app-sexe-list-etudiant',
  templateUrl: './sexe-list-etudiant.component.html',
  styleUrls: ['./sexe-list-etudiant.component.css']
})
export class SexeListEtudiantComponent implements OnInit {
   // declarations
