...
@Component({
  selector: 'app-compte-rendu-create-etudiant',
  templateUrl: './compte-rendu-create-etudiant.component.html',
  styleUrls: ['./compte-rendu-create-etudiant.component.css']
})
export class CompteRenduCreateEtudiantComponent implements OnInit {
