...
@Component({
  selector: 'app-compte-rendu-edit-etudiant',
  templateUrl: './compte-rendu-edit-etudiant.component.html',
  styleUrls: ['./compte-rendu-edit-etudiant.component.css']
})
export class CompteRenduEditEtudiantComponent implements OnInit {
