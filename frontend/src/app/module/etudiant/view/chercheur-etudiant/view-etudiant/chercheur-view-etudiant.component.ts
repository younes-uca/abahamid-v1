...
@Component({
  selector: 'app-chercheur-view-etudiant',
  templateUrl: './chercheur-view-etudiant.component.html',
  styleUrls: ['./chercheur-view-etudiant.component.css']
})
export class ChercheurViewEtudiantComponent implements OnInit {
