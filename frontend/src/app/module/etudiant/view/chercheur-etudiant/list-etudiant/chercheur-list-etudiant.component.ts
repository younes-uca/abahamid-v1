...
@Component({
  selector: 'app-chercheur-list-etudiant',
  templateUrl: './chercheur-list-etudiant.component.html',
  styleUrls: ['./chercheur-list-etudiant.component.css']
})
export class ChercheurListEtudiantComponent implements OnInit {
   // declarations
