...
@Component({
  selector: 'app-chercheur-edit-etudiant',
  templateUrl: './chercheur-edit-etudiant.component.html',
  styleUrls: ['./chercheur-edit-etudiant.component.css']
})
export class ChercheurEditEtudiantComponent implements OnInit {
