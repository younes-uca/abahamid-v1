...
@Component({
  selector: 'app-phase-image-view-etudiant',
  templateUrl: './phase-image-view-etudiant.component.html',
  styleUrls: ['./phase-image-view-etudiant.component.css']
})
export class PhaseImageViewEtudiantComponent implements OnInit {
