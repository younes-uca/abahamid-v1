...
@Component({
  selector: 'app-phase-image-create-etudiant',
  templateUrl: './phase-image-create-etudiant.component.html',
  styleUrls: ['./phase-image-create-etudiant.component.css']
})
export class PhaseImageCreateEtudiantComponent implements OnInit {
