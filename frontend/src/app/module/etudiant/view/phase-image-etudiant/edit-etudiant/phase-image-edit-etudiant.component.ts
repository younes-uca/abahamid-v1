...
@Component({
  selector: 'app-phase-image-edit-etudiant',
  templateUrl: './phase-image-edit-etudiant.component.html',
  styleUrls: ['./phase-image-edit-etudiant.component.css']
})
export class PhaseImageEditEtudiantComponent implements OnInit {
