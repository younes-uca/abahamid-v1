...
@Component({
  selector: 'app-examen-view-etudiant',
  templateUrl: './examen-view-etudiant.component.html',
  styleUrls: ['./examen-view-etudiant.component.css']
})
export class ExamenViewEtudiantComponent implements OnInit {
