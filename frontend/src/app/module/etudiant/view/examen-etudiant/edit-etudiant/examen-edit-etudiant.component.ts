...
@Component({
  selector: 'app-examen-edit-etudiant',
  templateUrl: './examen-edit-etudiant.component.html',
  styleUrls: ['./examen-edit-etudiant.component.css']
})
export class ExamenEditEtudiantComponent implements OnInit {
