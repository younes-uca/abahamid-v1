...
@Component({
  selector: 'app-examen-create-etudiant',
  templateUrl: './examen-create-etudiant.component.html',
  styleUrls: ['./examen-create-etudiant.component.css']
})
export class ExamenCreateEtudiantComponent implements OnInit {
