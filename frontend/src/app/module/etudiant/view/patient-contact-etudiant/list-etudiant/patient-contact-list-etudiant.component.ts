...
@Component({
  selector: 'app-patient-contact-list-etudiant',
  templateUrl: './patient-contact-list-etudiant.component.html',
  styleUrls: ['./patient-contact-list-etudiant.component.css']
})
export class PatientContactListEtudiantComponent implements OnInit {
   // declarations
