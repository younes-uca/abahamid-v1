...
@Component({
  selector: 'app-patient-contact-create-etudiant',
  templateUrl: './patient-contact-create-etudiant.component.html',
  styleUrls: ['./patient-contact-create-etudiant.component.css']
})
export class PatientContactCreateEtudiantComponent implements OnInit {
