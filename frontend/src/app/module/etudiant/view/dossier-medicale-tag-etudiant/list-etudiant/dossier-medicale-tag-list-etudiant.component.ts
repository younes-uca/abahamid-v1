...
@Component({
  selector: 'app-dossier-medicale-tag-list-etudiant',
  templateUrl: './dossier-medicale-tag-list-etudiant.component.html',
  styleUrls: ['./dossier-medicale-tag-list-etudiant.component.css']
})
export class DossierMedicaleTagListEtudiantComponent implements OnInit {
   // declarations
