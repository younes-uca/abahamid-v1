...
@Component({
  selector: 'app-dossier-medicale-tag-edit-etudiant',
  templateUrl: './dossier-medicale-tag-edit-etudiant.component.html',
  styleUrls: ['./dossier-medicale-tag-edit-etudiant.component.css']
})
export class DossierMedicaleTagEditEtudiantComponent implements OnInit {
