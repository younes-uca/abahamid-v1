...
@Component({
  selector: 'app-dossier-medicale-tag-create-etudiant',
  templateUrl: './dossier-medicale-tag-create-etudiant.component.html',
  styleUrls: ['./dossier-medicale-tag-create-etudiant.component.css']
})
export class DossierMedicaleTagCreateEtudiantComponent implements OnInit {
