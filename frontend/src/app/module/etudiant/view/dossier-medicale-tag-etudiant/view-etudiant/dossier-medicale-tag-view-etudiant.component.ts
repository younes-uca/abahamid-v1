...
@Component({
  selector: 'app-dossier-medicale-tag-view-etudiant',
  templateUrl: './dossier-medicale-tag-view-etudiant.component.html',
  styleUrls: ['./dossier-medicale-tag-view-etudiant.component.css']
})
export class DossierMedicaleTagViewEtudiantComponent implements OnInit {
