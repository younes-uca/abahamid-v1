...
@Component({
  selector: 'app-recueil-de-donnes-create-etudiant',
  templateUrl: './recueil-de-donnes-create-etudiant.component.html',
  styleUrls: ['./recueil-de-donnes-create-etudiant.component.css']
})
export class RecueilDeDonnesCreateEtudiantComponent implements OnInit {
