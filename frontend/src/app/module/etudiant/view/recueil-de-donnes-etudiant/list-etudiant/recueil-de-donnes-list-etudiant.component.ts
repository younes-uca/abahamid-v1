...
@Component({
  selector: 'app-recueil-de-donnes-list-etudiant',
  templateUrl: './recueil-de-donnes-list-etudiant.component.html',
  styleUrls: ['./recueil-de-donnes-list-etudiant.component.css']
})
export class RecueilDeDonnesListEtudiantComponent implements OnInit {
   // declarations
