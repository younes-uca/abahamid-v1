...
@Component({
  selector: 'app-recueil-de-donnes-edit-etudiant',
  templateUrl: './recueil-de-donnes-edit-etudiant.component.html',
  styleUrls: ['./recueil-de-donnes-edit-etudiant.component.css']
})
export class RecueilDeDonnesEditEtudiantComponent implements OnInit {
