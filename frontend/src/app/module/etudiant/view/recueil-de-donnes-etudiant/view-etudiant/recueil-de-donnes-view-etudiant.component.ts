...
@Component({
  selector: 'app-recueil-de-donnes-view-etudiant',
  templateUrl: './recueil-de-donnes-view-etudiant.component.html',
  styleUrls: ['./recueil-de-donnes-view-etudiant.component.css']
})
export class RecueilDeDonnesViewEtudiantComponent implements OnInit {
