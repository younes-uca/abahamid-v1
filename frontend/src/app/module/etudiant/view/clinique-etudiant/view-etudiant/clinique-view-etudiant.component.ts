...
@Component({
  selector: 'app-clinique-view-etudiant',
  templateUrl: './clinique-view-etudiant.component.html',
  styleUrls: ['./clinique-view-etudiant.component.css']
})
export class CliniqueViewEtudiantComponent implements OnInit {
