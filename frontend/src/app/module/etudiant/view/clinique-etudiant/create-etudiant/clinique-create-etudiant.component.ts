...
@Component({
  selector: 'app-clinique-create-etudiant',
  templateUrl: './clinique-create-etudiant.component.html',
  styleUrls: ['./clinique-create-etudiant.component.css']
})
export class CliniqueCreateEtudiantComponent implements OnInit {
