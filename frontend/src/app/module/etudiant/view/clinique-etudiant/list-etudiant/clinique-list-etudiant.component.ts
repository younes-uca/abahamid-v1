...
@Component({
  selector: 'app-clinique-list-etudiant',
  templateUrl: './clinique-list-etudiant.component.html',
  styleUrls: ['./clinique-list-etudiant.component.css']
})
export class CliniqueListEtudiantComponent implements OnInit {
   // declarations
