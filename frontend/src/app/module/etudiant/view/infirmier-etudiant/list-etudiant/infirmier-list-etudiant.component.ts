...
@Component({
  selector: 'app-infirmier-list-etudiant',
  templateUrl: './infirmier-list-etudiant.component.html',
  styleUrls: ['./infirmier-list-etudiant.component.css']
})
export class InfirmierListEtudiantComponent implements OnInit {
   // declarations
