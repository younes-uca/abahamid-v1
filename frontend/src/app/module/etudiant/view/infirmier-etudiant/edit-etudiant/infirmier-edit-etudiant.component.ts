...
@Component({
  selector: 'app-infirmier-edit-etudiant',
  templateUrl: './infirmier-edit-etudiant.component.html',
  styleUrls: ['./infirmier-edit-etudiant.component.css']
})
export class InfirmierEditEtudiantComponent implements OnInit {
