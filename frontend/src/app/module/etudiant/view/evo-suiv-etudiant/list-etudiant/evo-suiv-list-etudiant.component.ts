...
@Component({
  selector: 'app-evo-suiv-list-etudiant',
  templateUrl: './evo-suiv-list-etudiant.component.html',
  styleUrls: ['./evo-suiv-list-etudiant.component.css']
})
export class EvoSuivListEtudiantComponent implements OnInit {
   // declarations
