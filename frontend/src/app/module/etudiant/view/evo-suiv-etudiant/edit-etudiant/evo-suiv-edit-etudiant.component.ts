...
@Component({
  selector: 'app-evo-suiv-edit-etudiant',
  templateUrl: './evo-suiv-edit-etudiant.component.html',
  styleUrls: ['./evo-suiv-edit-etudiant.component.css']
})
export class EvoSuivEditEtudiantComponent implements OnInit {
