...
@Component({
  selector: 'app-evo-suiv-create-etudiant',
  templateUrl: './evo-suiv-create-etudiant.component.html',
  styleUrls: ['./evo-suiv-create-etudiant.component.css']
})
export class EvoSuivCreateEtudiantComponent implements OnInit {
