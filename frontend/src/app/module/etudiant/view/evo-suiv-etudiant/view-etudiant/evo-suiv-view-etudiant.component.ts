...
@Component({
  selector: 'app-evo-suiv-view-etudiant',
  templateUrl: './evo-suiv-view-etudiant.component.html',
  styleUrls: ['./evo-suiv-view-etudiant.component.css']
})
export class EvoSuivViewEtudiantComponent implements OnInit {
