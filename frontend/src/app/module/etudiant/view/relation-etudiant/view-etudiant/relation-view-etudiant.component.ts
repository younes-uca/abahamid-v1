...
@Component({
  selector: 'app-relation-view-etudiant',
  templateUrl: './relation-view-etudiant.component.html',
  styleUrls: ['./relation-view-etudiant.component.css']
})
export class RelationViewEtudiantComponent implements OnInit {
