...
@Component({
  selector: 'app-relation-create-etudiant',
  templateUrl: './relation-create-etudiant.component.html',
  styleUrls: ['./relation-create-etudiant.component.css']
})
export class RelationCreateEtudiantComponent implements OnInit {
