...
@Component({
  selector: 'app-medecin-view-etudiant',
  templateUrl: './medecin-view-etudiant.component.html',
  styleUrls: ['./medecin-view-etudiant.component.css']
})
export class MedecinViewEtudiantComponent implements OnInit {
