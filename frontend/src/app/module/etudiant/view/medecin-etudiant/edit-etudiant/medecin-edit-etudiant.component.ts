...
@Component({
  selector: 'app-medecin-edit-etudiant',
  templateUrl: './medecin-edit-etudiant.component.html',
  styleUrls: ['./medecin-edit-etudiant.component.css']
})
export class MedecinEditEtudiantComponent implements OnInit {
