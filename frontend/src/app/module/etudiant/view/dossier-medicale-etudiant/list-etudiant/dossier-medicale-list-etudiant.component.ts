...
@Component({
  selector: 'app-dossier-medicale-list-etudiant',
  templateUrl: './dossier-medicale-list-etudiant.component.html',
  styleUrls: ['./dossier-medicale-list-etudiant.component.css']
})
export class DossierMedicaleListEtudiantComponent implements OnInit {
   // declarations
