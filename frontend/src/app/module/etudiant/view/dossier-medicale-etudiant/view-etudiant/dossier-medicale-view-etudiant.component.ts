...
@Component({
  selector: 'app-dossier-medicale-view-etudiant',
  templateUrl: './dossier-medicale-view-etudiant.component.html',
  styleUrls: ['./dossier-medicale-view-etudiant.component.css']
})
export class DossierMedicaleViewEtudiantComponent implements OnInit {
