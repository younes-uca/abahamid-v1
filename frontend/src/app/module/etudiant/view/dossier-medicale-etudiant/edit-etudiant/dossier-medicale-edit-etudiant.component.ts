...
@Component({
  selector: 'app-dossier-medicale-edit-etudiant',
  templateUrl: './dossier-medicale-edit-etudiant.component.html',
  styleUrls: ['./dossier-medicale-edit-etudiant.component.css']
})
export class DossierMedicaleEditEtudiantComponent implements OnInit {
