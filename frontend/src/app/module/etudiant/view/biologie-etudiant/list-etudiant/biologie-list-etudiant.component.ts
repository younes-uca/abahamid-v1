...
@Component({
  selector: 'app-biologie-list-etudiant',
  templateUrl: './biologie-list-etudiant.component.html',
  styleUrls: ['./biologie-list-etudiant.component.css']
})
export class BiologieListEtudiantComponent implements OnInit {
   // declarations
