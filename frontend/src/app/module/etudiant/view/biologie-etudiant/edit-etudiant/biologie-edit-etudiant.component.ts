...
@Component({
  selector: 'app-biologie-edit-etudiant',
  templateUrl: './biologie-edit-etudiant.component.html',
  styleUrls: ['./biologie-edit-etudiant.component.css']
})
export class BiologieEditEtudiantComponent implements OnInit {
