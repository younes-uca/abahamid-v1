...
@Component({
  selector: 'app-biologie-view-etudiant',
  templateUrl: './biologie-view-etudiant.component.html',
  styleUrls: ['./biologie-view-etudiant.component.css']
})
export class BiologieViewEtudiantComponent implements OnInit {
