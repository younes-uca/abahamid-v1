...
@Component({
  selector: 'app-biologie-create-etudiant',
  templateUrl: './biologie-create-etudiant.component.html',
  styleUrls: ['./biologie-create-etudiant.component.css']
})
export class BiologieCreateEtudiantComponent implements OnInit {
